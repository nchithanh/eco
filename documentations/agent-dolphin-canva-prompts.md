...
```
Soft lavender/violet studio light (#8b5cf6 accent), clean modern SaaS product photography, glass UI panels, warm empathy mood (not cold robot), shallow depth of field, no third-party logos, no watermark, no text overlays, no neon cyberpunk, no emoji
```

| # | Save as | Aspect | Prompt |
| --- | --- | --- | --- |
| 1 | `public/capabilities/agent-dolphin.jpg` | 16:10 | Product marketing photo, soft lavender violet studio lighting, website UI with a floating customer-support chat widget featuring a friendly dolphin AI assistant avatar, warm conversation bubbles (blurred unreadable text), premium SMB SaaS look, gentle bokeh, 16:10 aspect, no logos, no watermark, no text overlays |
| 2 | `public/services/agent-dolphin/hero.jpg` | 16:9 | Cinematic wide 16:9 shot, soft violet studio light, modern laptop on a clean desk showing a customer care chat panel powered by an AI agent with a subtle dolphin motif, warm ambient light conveying empathy and trust, shallow depth of field, contemporary SMB office atmosphere, no watermark, no text overlays |
