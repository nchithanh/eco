...
- Logo asset: `public/brand/logo-dolphin.webp` (PNG kept as source archive if needed)
...
- Mascots: `public/mascot/dolphin-eco.webp`, `dolphin-chat.webp`, `dolphin-contact.webp` (WebP, sized for display)
