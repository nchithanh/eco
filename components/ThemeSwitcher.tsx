    ...
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <ul
          ...
          role="listbox"
          aria-label={labels.aria}
          className="absolute right-0 z-50 mt-2 min-w-[11rem] overflow-hidden rounded-xl border border-white/70 bg-white/95 py-1 shadow-[0_12px_30px_rgb(var(--kuct-accent-rgb)/0.14)] backdrop-blur-xl"
        >
