  ...
  return (
    <article>
      <a
        ...
        className="group grid overflow-hidden rounded-2xl border border-[var(--kuct-accent)]/40 bg-[rgba(8,8,20,0.72)] shadow-[0_0_2rem_rgba(var(--kuct-accent-rgb),0.18)] transition duration-500 hover:border-[var(--kuct-accent)]/60 hover:shadow-[0_0_2.5rem_rgba(var(--kuct-accent-rgb),0.28)] lg:grid-cols-2"
      >
        <div className="flex flex-col justify-center px-5 py-6 sm:px-7 sm:py-8 lg:px-8 lg:py-10">
          ...
          <span className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[var(--kuct-accent)] transition group-hover:text-[var(--kuct-text)]">
            ...
            <span
              aria-hidden
              className="inline-flex size-8 items-center justify-center rounded-full border border-[var(--kuct-accent)]/35 text-xs"
            >
              ↗
            </span>
          </span>
        ...
        <div className="relative aspect-[16/10] overflow-hidden bg-[rgba(12,10,24,0.6)] lg:aspect-auto lg:min-h-[18rem]">
          <LazyImage
          ...
          <span
            aria-hidden
            className="absolute right-4 top-4 inline-flex size-10 items-center justify-center rounded-full border border-[var(--kuct-accent)]/45 bg-[rgba(var(--kuct-accent-rgb),0.14)] text-sm text-[var(--kuct-accent)] shadow-[0_0_1.25rem_rgba(var(--kuct-accent-rgb),0.35)] transition group-hover:bg-[rgba(var(--kuct-accent-rgb),0.22)]"
          >
            ↗
          </span>
        </div>
    ...
    <li className="h-full">
      <article className="h-full">
        <a
          href={href}
          onClick={(event) => onOpen(href, event)}
          className="group flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--kuct-border)] bg-[rgba(8,8,20,0.62)] transition duration-500 hover:border-[var(--kuct-accent)]/40 hover:shadow-[0_0_1.75rem_rgba(var(--kuct-accent-rgb),0.16)]"
        >
          <div className="relative aspect-[16/10] overflow-hidden bg-[rgba(12,10,24,0.6)]">
            <LazyImage
              src={themeAsset(getNewsImage(item.slug), theme)}
              alt={item.title}
              fill
          ...
          <div className="flex flex-1 flex-col px-4 py-4 sm:px-5 sm:py-5">
            ...
            <span className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-[var(--kuct-accent)] transition group-hover:text-[var(--kuct-text)]">
              ...
              <span
                aria-hidden
                className="inline-flex size-7 items-center justify-center rounded-full border border-[var(--kuct-accent)]/30 text-[10px]"
              >
                ↗
              </span>
            </span>
