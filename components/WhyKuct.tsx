          ...
          {reasons.map((reason, index) => {
            ...
            return (
              <Reveal
                ...
                className={
                  isLead
                    ? "group relative overflow-hidden rounded-2xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] p-5 ring-1 ring-[var(--kuct-accent)]/25 backdrop-blur-md transition duration-300 hover:border-[var(--kuct-accent)]/40 sm:p-6"
                    : "group relative overflow-hidden rounded-2xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] p-5 backdrop-blur-md transition duration-300 hover:border-[var(--kuct-accent)]/35 sm:p-6"
                }
              >
