  ...
  return (
    <section className="relative overflow-hidden border-b border-white/40 py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <h1 className="mx-auto mt-3 max-w-2xl font-display text-4xl font-semibold tracking-tight text-[var(--kuct-text)] sm:text-5xl">
          <BrandText size="md">{h.headline}</BrandText>
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-base text-[var(--kuct-muted)] sm:text-lg">
          {h.support}
        </p>
      </div>
    </section>
