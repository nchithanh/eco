          ...
          {SCHEMA_HOMEPAGE_SLUGS.map((slug, i) => (
            <li key={slug}>
              <Link
                ...
                className="flex items-center gap-3 rounded-xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] px-4 py-3 transition hover:border-[var(--kuct-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kuct-accent)]"
              >
