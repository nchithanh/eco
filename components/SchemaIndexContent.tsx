...
export function SchemaIndexContent() {
 ...
 className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--kuct-bg)]"
 >
 ...
 <ul className="mt-4 flex list-none flex-wrap gap-2 pt-4 p-0">
