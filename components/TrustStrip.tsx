...
export function TrustStrip() {
 ...
 className={
 isLead
 ? "rounded-xl bg-[var(--kuct-panel)] p-5 backdrop-blur-md transition duration-300 "
 : "rounded-xl bg-[var(--kuct-panel)] p-5 backdrop-blur-md transition duration-300 "
 }
 >
 ...
 <Reveal
 delay={200}
 className="mt-5 rounded-xl bg-[var(--kuct-panel)] p-5 backdrop-blur-md transition duration-300 sm:p-6"
 >
