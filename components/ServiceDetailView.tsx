      ...
      <section
        className={
          embedded
            ...
            : "relative overflow-hidden border-b border-[var(--kuct-border)] py-16 sm:py-20 lg:py-24"
        }
      >
          ...
          >
            <Reveal variant="left" className="min-w-0">
              ...
              {card?.tags ? (
                <ul className="mt-6 flex list-none flex-wrap gap-2 p-0">
                  {card.tags.map((tag) => (
                    <li
                      key={tag}
                      className="rounded-full border border-[var(--kuct-border)] bg-[rgba(10,10,22,0.72)] px-3 py-1.5 text-xs font-semibold text-[var(--kuct-muted)]"
                    >
                      {tag}
                    </li>
                  ))}
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <button
                  type="button"
                  className="kuct-btn-primary inline-flex items-center rounded-full px-8 py-3.5 text-sm font-semibold shadow-[0_14px_36px_rgb(var(--kuct-accent-rgb)/0.4)]"
            ...
            <Reveal variant="right" delay={80} className="relative">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] ring-1 ring-[var(--kuct-accent)]/15 sm:aspect-[16/11]">
      ...
      >
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-10 grid gap-4 lg:mt-12 lg:grid-cols-2 lg:gap-5">
            <Reveal className="rounded-2xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] p-5 ring-1 ring-[var(--kuct-accent)]/15 backdrop-blur-md sm:p-6">
          ...
          <Reveal className="mt-12 rounded-[1.5rem] border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] px-6 py-8 text-center ring-1 ring-[var(--kuct-accent)]/15 sm:mt-14 sm:px-10 sm:py-10">
            <button
              type="button"
              className="kuct-btn-primary inline-flex items-center rounded-full px-8 py-3.5 text-sm font-semibold shadow-[0_14px_36px_rgb(var(--kuct-accent-rgb)/0.4)]"
              onClick={openQuoteFlow}
