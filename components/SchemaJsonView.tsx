      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a
            href={rawHref}
            download
            className="inline-flex items-center rounded-full border border-[var(--kuct-border)] px-6 py-2.5 text-sm font-semibold text-[var(--kuct-text)] transition hover:border-[var(--kuct-accent)]"
          >
            Tải file
          </a>
        </div>
        ...
        <pre
          className="mt-8 overflow-x-auto rounded-2xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.92)] p-4 text-left text-[12px] leading-relaxed text-[var(--kuct-muted)] sm:p-6 sm:text-[13px]"
          tabIndex={0}
        >
          <code>{pretty}</code>
        </pre>
