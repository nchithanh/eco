...
export function PopularServices({
 ...
 <div className="relative flex flex-col bg-[var(--kuct-panel)] lg:min-h-[22rem]">
 <div
 ...
 className="relative z-[1] grid grid-cols-2 gap-1.5 p-2 sm:gap-2 sm:p-2.5 lg:flex lg:overflow-x-auto lg:touch-[pan-x_pan-y]"
 >
 {packages.map((pkg) => {
 ...
 className={
 isSelected
 ? "relative rounded-lg bg-[rgba(var(--kuct-accent-rgb),0.16)] px-2.5 py-2.5 text-left transition sm:px-3 sm:py-3 lg:min-w-0 lg:flex-1"
 : "relative rounded-lg px-2.5 py-2.5 text-left transition hover:bg-[rgba(255,255,255,0.04)] sm:px-3 sm:py-3 lg:min-w-0 lg:flex-1"
 }
 >
 ...
 <li
 key={key}
 className="flex items-start justify-between gap-3 py-2.5 first:pt-0 last:border-b-0 sm:items-center sm:gap-4 sm:py-3"
 >
 ...
 <div className="mt-4 flex flex-col gap-3 pt-4 sm:mt-5 sm:flex-row sm:items-end sm:justify-between sm:gap-4 sm:pt-5">
 <div>
