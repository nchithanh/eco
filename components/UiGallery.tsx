      ...
      <div className="mx-auto max-w-7xl px-6">
              ...
              return (
                ...
                >
                  <a
                    ...
                    className={
                      featured
                        ? "group flex h-full flex-col overflow-hidden rounded-xl border border-[var(--kuct-accent)]/35 bg-[rgba(6,6,14,0.92)] shadow-[0_12px_32px_rgba(0,0,0,0.35)] ring-1 ring-[var(--kuct-accent)]/20 transition duration-300 hover:-translate-y-0.5 hover:border-[var(--kuct-accent)]/50 hover:shadow-[0_18px_40px_rgb(var(--kuct-accent-rgb)/0.12)]"
                        : "group flex h-full flex-col overflow-hidden rounded-xl border border-[var(--kuct-border)] bg-[rgba(6,6,14,0.88)] transition duration-300 hover:-translate-y-0.5 hover:border-[var(--kuct-accent)]/40 hover:shadow-[0_16px_36px_rgb(var(--kuct-accent-rgb)/0.1)]"
                    }
                  >
                    <div className="relative aspect-[4/3] overflow-hidden bg-[rgba(10,10,22,0.8)]">
                      ...
                      {badge ? (
                        <span className="absolute top-2.5 left-2.5 rounded-full border border-[var(--kuct-accent)]/40 bg-[rgba(var(--kuct-accent-rgb),0.2)] px-2 py-0.5 text-[10px] font-semibold tracking-wide text-[var(--kuct-accent)] uppercase backdrop-blur-sm">
                          {badge}
                        </span>
                      ) : null}
                    </div>
        ...
        <Reveal delay={120} className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <button
            type="button"
            onClick={openQuote}
            className="inline-flex items-center justify-center rounded-full border border-[var(--kuct-border)] bg-[rgba(10,10,22,0.8)] px-8 py-3 text-sm font-semibold text-[var(--kuct-text)] transition hover:border-[var(--kuct-accent)]/40 hover:text-[var(--kuct-accent)]"
          >
            {copy.ctaConsult}
          </button>
        </Reveal>
