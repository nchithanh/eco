...
function PreviewLoading({ label }: { label: string }) {
 ...
 <div
 aria-hidden
 className="size-10 animate-spin rounded-full border-t-[var(--kuct-accent)]"
 />
...
export function PagePreviewModal({
 ...
 className="relative z-10 flex max-h-[min(92svh,56rem)] w-full max-w-5xl flex-col overflow-hidden rounded-xl bg-[var(--kuct-panel)] shadow-[0_1.5rem_4rem_rgb(0_0_0/0.5)]"
 >
 <div className="flex shrink-0 items-center justify-between gap-3 border-b bg-[var(--kuct-panel)] px-4 py-3 backdrop-blur-xl sm:px-5">
 <button
 type="button"
