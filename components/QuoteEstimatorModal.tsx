...
const fieldClass =
 "mt-1.5 w-full rounded-lg border border-black/15 bg-[var(--kuct-panel-2)] px-4 py-2.5 text-sm text-[var(--kuct-text)] outline-none transition focus:border-black/40";
...
function ChoiceButton({
 ...
 className={
 active
 ? "flex min-h-[2.75rem] flex-col justify-center rounded-lg bg-[rgba(var(--kuct-accent-rgb),0.12)] px-3 py-2 text-left text-sm font-semibold text-[var(--kuct-text)] "
 : "flex min-h-[2.75rem] flex-col justify-center rounded-lg bg-[var(--kuct-panel-2)] px-3 py-2 text-left text-sm font-medium text-[var(--kuct-muted)] transition duration-200 hover:text-[var(--kuct-text)]"
 }
 >
...
export function QuoteEstimatorModal({
 ...
 <div className="sticky top-0 z-[1] mb-7 rounded-xl bg-[var(--kuct-panel-2)] px-4 py-4 backdrop-blur-md sm:px-5">
