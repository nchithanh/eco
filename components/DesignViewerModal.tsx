...
export function DesignViewerModal({
 ...
 className="relative z-10 flex max-h-[min(94svh,60rem)] w-full max-w-4xl flex-col overflow-hidden rounded-xl bg-[var(--kuct-panel)] shadow-[0_1.5rem_4rem_rgb(0_0_0/0.5)]"
 >
 ...
 <div className="min-h-0 flex-1 overflow-y-auto bg-[var(--kuct-panel)]">
