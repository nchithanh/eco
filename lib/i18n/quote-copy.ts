...
const vi: QuoteCopy = {
  ...
  mailSubject: "[Dolphin Kich] Yêu cầu báo giá —",
  mailBodyName: "Họ tên",
...
const en: QuoteCopy = {
  ...
  mailSubject: "[Dolphin Kich] Quote request —",
  mailBodyName: "Name",
...
const de: QuoteCopy = {
  ...
  mailSubject: "[Dolphin Kich] Angebotsanfrage —",
  mailBodyName: "Name",
