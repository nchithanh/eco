...
const vi: CustomAgentCopy = {
  metaTitle: "AI Agent theo yêu cầu | Dolphin Kich",
  metaDescription:
  ...
  processEyebrow: "Cách Dolphin Kich làm",
  ...
  closeCta: "Liên hệ Dolphin Kich",
};

const en: CustomAgentCopy = {
  metaTitle: "Custom AI agents | Dolphin Kich",
  metaDescription:
  ...
  processEyebrow: "How Dolphin Kich works",
  ...
  closeCta: "Contact Dolphin Kich",
};

const de: CustomAgentCopy = {
  metaTitle: "Individuelle AI-Agents | Dolphin Kich",
  metaDescription:
...
const ja: CustomAgentCopy = {
  metaTitle: "要件対応 AI Agent | Dolphin Kich",
  metaDescription:
...
const zh: CustomAgentCopy = {
  metaTitle: "按需定制 AI Agent | Dolphin Kich",
  metaDescription:
  ...
  processEyebrow: "Dolphin Kich 的做法",
