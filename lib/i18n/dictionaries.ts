...
const vi: Dictionary = {
  ...
  capabilities: {
    ...
    moreServices: [
      ...
      { label: "Phần mềm", href: "/services/software" },
    ...
    items: [
      ...
      },
      {
        ...
        body: "Website, web app, hệ thống nội bộ, backend/API và tích hợp — theo bài toán thực tế, bàn giao để vận hành tiếp.",
...
const ja: Dictionary = {
  ...
  capabilities: {
    ...
    moreServices: [
      ...
      { label: "ソフトウェア", href: "/services/software" },
      { label: "UI/UX", href: "/services/design" },
